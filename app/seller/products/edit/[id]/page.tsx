...
export default function EditProductPage() {
  ...
  // Mock existing product data - in real app would fetch from API
  const [formData, setFormData] = useState({
    name: "Handwoven Silk Scarf",
    description:
      "A beautiful handwoven silk scarf made using traditional Spanish techniques passed down through generations.",
    story:
      "This scarf represents 25 years of weaving expertise, combining traditional Spanish patterns with contemporary design.",
    category: "Textiles",
    subcategory: "Scarves",
    price: "145",
    compareAtPrice: "180",
    ...
    tags: ["handmade", "traditional", "luxury"],
    seoTitle: "Handwoven Silk Scarf - Traditional Spanish Craftsmanship",
    seoDescription: "Beautiful handwoven silk scarf made using traditional techniques. Perfect for any occasion.",
    isActive: true,
    isFeatured: false,
  })

  const [images, setImages] = useState([
    "/handwoven-silk-scarf-with-traditional-patterns.jpg",
    "/placeholder.svg?key=scarf2",
    "/placeholder.svg?key=scarf3",
  ])
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <Badge className="bg-blue-100 text-blue-800">ID: {productId}</Badge>
            </div>
            <div className="flex items-center space-x-4">
              <Button
                variant="outline"
      ...
      <div className="container mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Main Content - Same as Add Product but with existing data */}
          ...
          {/* Sidebar - Same structure as Add Product */}
